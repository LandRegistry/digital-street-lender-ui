...
from lender_ui.custom_extensions.content_security_policy.main import ResponseWithoutCSP
...
class TestContentSecurityPolicy(unittest.TestCase):
    ...
    @mock.patch('lender_ui.custom_extensions.content_security_policy.main.ContentSecurityPolicy.init_app')
    ...
    @mock.patch('lender_ui.custom_extensions.content_security_policy.reporting.logger.error')
